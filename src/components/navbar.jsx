                    ...
                    <div class="container ">
                        ...
                        <div class="collapse navbar-collapse  " id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                                ...
                                <li class="nav-item ">
                                    <Link to='/aboutinstitute' className='nav-link'>About Us</Link>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#">Publication Etics</a></li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <Link to='/upload' className='dropdown-item'>Upload</Link>
